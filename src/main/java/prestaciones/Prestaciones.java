...
/**
 * Objeto de prestaciones.
 * Basado en https://www.dominicanaenlaweb.com/calculo-prestaciones-laborales-republica-dominicana/.
 *
 */
public class Prestaciones {
    ...
    public Prestaciones(Date fechaDeContratacion, Date fechaDeSalida, double salarioMensual) {
        double salarioxdia = salarioMensual * (double)12 / (double)365;
        long meses = Period.between(
            fechaDeContratacion.toLocalDate(),
            LocalDate.now()
        ).toTotalMonths();
